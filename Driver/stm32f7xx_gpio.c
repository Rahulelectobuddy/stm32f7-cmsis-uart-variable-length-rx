...
void init_gpio(void)
{
	...
	pRCC_Handle->AHB1ENR |= RCC_AHB1ENR_GPIODEN;
	...
	pGPIO_Handle = GPIOD;
	pGPIO_Handle->MODER = GPIO_MODER_MODER6_1|GPIO_MODER_MODER5_1;
	pGPIO_Handle->AFR[0] |= GPIO_AFRL_AFRL6_0|GPIO_AFRL_AFRL6_1|GPIO_AFRL_AFRL6_2;
	pGPIO_Handle->AFR[0] |= GPIO_AFRL_AFRL5_0|GPIO_AFRL_AFRL5_1|GPIO_AFRL_AFRL5_2;
	pGPIO_Handle->OSPEEDR |= GPIO_OSPEEDR_OSPEEDR6;
	pGPIO_Handle->OSPEEDR	|= GPIO_OSPEEDR_OSPEEDR5;
	pGPIO_Handle->PUPDR |= GPIO_PUPDR_PUPDR6_0|GPIO_PUPDR_PUPDR5_0;
